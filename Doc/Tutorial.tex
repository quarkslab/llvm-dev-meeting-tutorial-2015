...
\date{March 17, 2016, LLVM Developers' Meeting}
...

{
    ...
    \begin{frame}{LLVM 3.8 --- Resources}
        \begin{center}
            \url{https://github.com/quarkslab/llvm-dev-meeting-tutorial-2015}
        \end{center}
        \hfill\emph{\footnotesize the repo actually got updated for this talk, ft. LLVM 3.8}
    \end{frame}
    ...
    \begin{frame}{LLVM 3.8 --- Tutorial}
        \begin{center}
            \textbf{\Large Press Start Button}
        \end{center}
    \end{frame}

    \begin{frame}{LLVM 3.8 --- Prerequisite}
        \begin{center}
            \textbf{\Large Please Load LLVM3.8}
        \end{center}
    \end{frame}

    \begin{frame}{LLVM 3.8}
        \begin{center}
            \begin{itemize}
                \centering
...
\end{lstlisting}
    ...
    \begin{frame}[containsverbatim]
        ...
        {
            \footnotesize
            \lstinputlisting[linerange={24-24,27-27,46-46,53-53,63-63,65-65,76-77,140-142},language=c++]{../MBA/MBA.cpp}
        }
    \end{frame}
...
% opt -O2 -mba -debug-only=mba ... # selective
    ...
    \begin{frame}[containsverbatim]{stage 3 --- Building an Analysis}
        ...
        {
        \scriptsize
        \lstinputlisting[breaklines=false,linerange={103-108},language=c++]{../ReachableIntegerValues/ReachableIntegerValues.cpp}
        }
        \end{alertblock}
    ...
    \begin{frame}[containsverbatim]{stage 3 --- Analysis}
        ...
        {
        \footnotesize
        \lstinputlisting[breaklines=true,linerange={14-17},language=c++]{../include/ReachableIntegerValues.h}
        }
    \end{frame}
    ...
    \begin{frame}[containsverbatim]{stage 3 --- \texttt{print}}
        \begin{alertblock}{Usage}
        {
        \footnotesize
\begin{lstlisting}
> opt test.ll -load lib/LLVMReachableIntegerValues.so \
    -analyze -reachable-integer-values
\end{lstlisting}
        }
        \end{alertblock}
        ...
        {
        \footnotesize
        \lstinputlisting[breaklines=true,linerange={94-100},language=c++]{../ReachableIntegerValues/ReachableIntegerValues.cpp}
        }
        \end{alertblock}
