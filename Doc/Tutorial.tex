...
\lstinputlisting[linerange={130-136,139-140},language=bash,morekeywords={list,include,find_python_module,REQUIRED,add_custom_target,COMMAND}]{../MBA/MBA.cpp}
    ...
    \begin{minipage}{\textwidth}
        \footnotesize
        \lstinputlisting[breaklines=false,linerange={102-103},language=c++]{../MBA/MBA.cpp}
    \end{minipage}
    \end{frame}
    ...
    \begin{frame}[containsverbatim]{stage 2 --- Bonus}
        ...
        \begin{minipage}{\textwidth}
            \footnotesize
            \lstinputlisting[breaklines=false,linerange={105-106},language=c++]{../MBA/MBA.cpp}
        \end{minipage}
...
\end{lstlisting}
    ...
    \begin{frame}[containsverbatim]{stage 2 --- Bonus}
        ...
        \begin{minipage}{\textwidth}
        \footnotesize
        \lstinputlisting[breaklines=false,linerange={104-104},language=c++]{../MBA/MBA.cpp}
        \end{minipage}
        \end{alertblock}
...
\end{lstlisting}
    ...
    \begin{frame}[containsverbatim]{stage 4 --- Forge a Random Branch}
        ...
        \begin{minipage}{\textwidth}
        \scriptsize
        \lstinputlisting[breaklines=false,linerange={69-70},language=c++]{../DuplicateBB/DuplicateBB.cpp}
        \end{minipage}
        ...
        \begin{minipage}{\textwidth}
        \scriptsize
        \lstinputlisting[breaklines=false,linerange={83-85},language=c++]{../DuplicateBB/DuplicateBB.cpp}
        \end{minipage}

        \structure{Random condition}\\
        \begin{minipage}{\textwidth}
        \scriptsize
        \lstinputlisting[breaklines=false,linerange={121-124},language=c++]{../DuplicateBB/DuplicateBB.cpp}
        \end{minipage}
    \end{frame}
