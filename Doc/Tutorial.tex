...
\end{lstlisting}
    ...
    \begin{frame}[containsverbatim]
        ...
        {
            \footnotesize
            \lstinputlisting[linerange={24-24,27-27,46-46,53-53,59-59,61-61,72-73,127-129},language=c++]{../MBA/MBA.cpp}
        }
    \end{frame}
    ...
    \begin{frame}[containsverbatim]
        ...
        {
            \footnotesize
            \lstinputlisting[breaklines=true,linerange={134-142},language=c++]{../MBA/MBA.cpp}
        }
    \end{frame}
...
{
\scriptsize
\lstinputlisting[linerange={146-151,155-156},language=bash,morekeywords={list,include,find_python_module,REQUIRED,add_custom_target,COMMAND}]{../MBA/MBA.cpp}
}
    \end{frame}
    ...
    \begin{minipage}{\textwidth}
        \footnotesize
        \lstinputlisting[breaklines=false,linerange={95-103},language=c++]{../MBA/MBA.cpp}
    \end{minipage}
    \end{frame}
    ...
    \begin{minipage}{\textwidth}
        \footnotesize
        \lstinputlisting[breaklines=false,linerange={118-119},language=c++]{../MBA/MBA.cpp}
    \end{minipage}
    \end{frame}
    ...
    \begin{frame}[containsverbatim]{stage 2 --- Bonus}
        ...
        \begin{minipage}{\textwidth}
            \footnotesize
            \lstinputlisting[breaklines=false,linerange={121-122},language=c++]{../MBA/MBA.cpp}
        \end{minipage}
...
\end{lstlisting}
    ...
    \begin{frame}[containsverbatim]{stage 2 --- Bonus}
        ...
        \begin{minipage}{\textwidth}
        \footnotesize
        \lstinputlisting[breaklines=false,linerange={105-105},language=c++]{../MBA/MBA.cpp}
        \end{minipage}
        \end{alertblock}
