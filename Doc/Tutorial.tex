...

{
    ...
    \begin{frame}[containsverbatim]
        ...
        \begin{block}{Propagate LLVM setup to our project}
            \footnotesize
            \lstinputlisting[firstline=24, lastline=28,language=bash,morekeywords={add_definitions,include_directories},breaklines=true]{../CMakeLists.txt}
        \end{block}

        \begin{block}{Get Ready!}
            \footnotesize
            \lstinputlisting[firstline=35, lastline=35,language=bash,morekeywords={add_subdirectory}]{../CMakeLists.txt}
        \end{block}
    \end{frame}
...
\end{lstlisting}
    ...
    \begin{frame}[containsverbatim]
        ...
        {
            \footnotesize
            \lstinputlisting[linerange={24-24,27-27,46-46,53-53,59-59,61-61,72-73,125-127},language=c++]{../MBA/MBA.cpp}
        }
    \end{frame}
    ...
    \begin{frame}[containsverbatim]
        ...
        {
            \footnotesize
            \lstinputlisting[breaklines=true,linerange={132-140},language=c++]{../MBA/MBA.cpp}
        }
    \end{frame}
...
{
\scriptsize
\lstinputlisting[linerange={40-42,51-54},language=bash,morekeywords={list,include,find_python_module,REQUIRED,add_custom_target,COMMAND}]{../CMakeLists.txt}
}
        \end{block}
    \end{frame}
...
{
\scriptsize
\lstinputlisting[linerange={144-149,153-154},language=bash,morekeywords={list,include,find_python_module,REQUIRED,add_custom_target,COMMAND}]{../MBA/MBA.cpp}
}
    \end{frame}
    ...
    {
        \footnotesize
        \lstinputlisting[breaklines=true,linerange={76-79,83-83,87-88},language=c++]{../MBA/MBA.cpp}
    }
    \end{frame}
    ...
    \begin{minipage}{\textwidth}
        \footnotesize
        \lstinputlisting[breaklines=false,linerange={94-102},language=c++]{../MBA/MBA.cpp}
    \end{minipage}
    \end{frame}
    ...
    \begin{minipage}{\textwidth}
        \footnotesize
        \lstinputlisting[breaklines=false,linerange={116-117},language=c++]{../MBA/MBA.cpp}
    \end{minipage}
    \end{frame}
    ...
    \begin{frame}[containsverbatim]{stage 2 --- Bonus}
        ...
        \begin{minipage}{\textwidth}
            \footnotesize
            \lstinputlisting[breaklines=false,linerange={119-120},language=c++]{../MBA/MBA.cpp}
        \end{minipage}
...
\end{lstlisting}
    ...
    \begin{frame}[containsverbatim]{stage 2 --- Bonus}
        ...
        \begin{minipage}{\textwidth}
        \footnotesize
        \lstinputlisting[breaklines=false,linerange={103-103},language=c++]{../MBA/MBA.cpp}
        \end{minipage}
        \end{alertblock}
