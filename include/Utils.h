...
template<>
class parser<Ratio> : public basic_parser<Ratio> {
  public:
...
// The random number generator bundled with LLVM is not compatible with <random> (bug opened!)
...
class RandomNumberGenerator {
  ...
  public:
    ...
    static constexpr generator_type::result_type min() { return generator_type::min(); }
    static constexpr generator_type::result_type max() { return generator_type::max(); }
};
